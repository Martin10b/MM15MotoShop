...
<section class="home">
        ...
        <div class="container" id="product-cards">
            <h1 class="text-center">Комплекти пластмаси</h1>
            <div class="row" style="margin-top: 30px;">
            <?php
            $sql = "SELECT * FROM products WHERE category=8";
              ...
              <div class="card h-100">
                ...
                <div class="card-body d-flex flex-column justify-content-end">
                  ...
                  if(isset($_SESSION['useruid']) && isset($_SESSION['userType']) && ($_SESSION['userType'] == 1)) {                    
                    echo '<h2 class="price">'.$row['price'].' лв. </h2><button onclick="deleteProduct('.$row["id"].');" style="background-color: red; color: white; border-radius: 10px;" style="background-color: red; color: white; border-radius: 10px;">Delete</button>';
                  } else {
